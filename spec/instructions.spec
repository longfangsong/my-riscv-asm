...
lbu         {{params[1] | bits_at(start=0, end=12)}}{{params[2] | register}}100{{params[0] | register}}0000011
lhu         {{params[1] | bits_at(start=0, end=12)}}{{params[2] | register}}101{{params[0] | register}}0000011
sb          {{params[1] | bits_at(start=5, end=12)}}{{params[0] | register}}{{params[2] | register}}000{{params[1] | bits_at(start=0, end=5)}}0100011
sh          {{params[1] | bits_at(start=5, end=12)}}{{params[0] | register}}{{params[2] | register}}001{{params[1] | bits_at(start=0, end=5)}}0100011
sw          {{params[1] | bits_at(start=5, end=12)}}{{params[0] | register}}{{params[2] | register}}010{{params[1] | bits_at(start=0, end=5)}}0100011
addi        {{params[2] | bits_at(start=0, end=12)}}{{params[1] | register}}000{{params[0] | register}}0010011
slti        {{params[2] | bits_at(start=0, end=12)}}{{params[1] | register}}010{{params[0] | register}}0010011
sltiu       {{params[2] | bits_at(start=0, end=12)}}{{params[1] | register}}011{{params[0] | register}}0010011
xori        {{params[2] | bits_at(start=0, end=12)}}{{params[1] | register}}100{{params[0] | register}}0010011
ori         {{params[2] | bits_at(start=0, end=12)}}{{params[1] | register}}110{{params[0] | register}}0010011
andi        {{params[2] | bits_at(start=0, end=12)}}{{params[1] | register}}111{{params[0] | register}}0010011
slli        0000000{{params[2] | bits_at(start=0, end=5)}}{{params[1] | register}}001{{params[0] | register}}0010011
srli        0000000{{params[2] | bits_at(start=0, end=5)}}{{params[1] | register}}101{{params[0] | register}}0010011
srai        0100000{{params[2] | bits_at(start=0, end=5)}}{{params[1] | register}}101{{params[0] | register}}0010011
...
csrrwi      {{params[1] | csr}}{{params[2] | bits_at(start=0, end=5)}}101{{params[0] | register}}1110011
csrrsi      {{params[1] | csr}}{{params[2] | bits_at(start=0, end=5)}}110{{params[0] | register}}1110011
csrrci      {{params[1] | csr}}{{params[2] | bits_at(start=0, end=5)}}111{{params[0] | register}}1110011
